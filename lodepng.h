...
function creates a new chunk with the given parameters and appends it. ObjectType is the 4-letter
name of the chunk.
...
int main(int argc, char *argv[]) {
  ...
  //the pixels are now in the vector "image", 4 bytes per pixel, ordered RGBARGBA..., use it as texture0, draw it, ...
}
